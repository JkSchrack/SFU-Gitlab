...
int main( int argc, char* argv[] )
{
  ...
  //img = newimg;
  // t8; make imgwidth & imgheight half when testing

  //region_set(img, imgwidth, imgheight, 10, 10, 100, 100, 0);
  //img = newimg;
  //t9

  uint8_t *newimg = region_copy(img, imgwidth, imgheight, 100, 100, imgwidth - 100, imgheight - 100);
  img = newimg;
  //t11
  ...
  draw_image_grey( img, imgwidth- 200, imgheight - 200 );
